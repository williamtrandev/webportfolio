...
export default function About() {
    ...
    // 1111111111111111111 
    const ADDElement = () => {
        let idMax = Math.max.apply(Math, skill4.map(function(o) { return o.id; }))
        // console.log(idMax);
        const newGT = {
            id: 1+ idMax,
            skill: "add",
      ...
      const DELETEElement1 = (e) => {
        let indexRemove= e.target.parentElement.parentElement.getAttribute("data-key");
        // console.log(indexRemove);
        if(indexRemove == 1 || indexRemove == 2 || indexRemove == 3 || indexRemove == 4 || indexRemove == 5 || indexRemove == 6){
            return;
        }
      ...
      const ADDElement2 = () => {
        let idMax = Math.max.apply(Math, edu4.map(function(o) { return o.id; }))
        console.log(idMax);
        const newGT = {
            id: 1 + idMax,
            time: "year",
      ...
      const ADDElement3 = () => {
        let idMax = Math.max.apply(Math, exp4.map(function(o) { return o.id; }))
        console.log(idMax);
        const newGT = {
            id: 1 + idMax,
            time: "time",
                    ...
                    <div className="about-content padd-15">
                        <div className="row">
                            <div className="about-text padd-15">
                                ...
                                <p
                                    ...
                                    suppressContentEditableWarning={true}
                                >
                                    hdahasjadajdakldkacmancjafkjsfkamscaskafajcnamca,cajs
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="row">
                            ...
                            <div id="Skill_Sample4" className=" skills padd-15">
                                <h2 className="text-4xl py-2 font-bold text-center">My Skills</h2>
                                <div className="row">
                                    {skill4.map((item) => (
                                            ...
                                            className="skills-item congviec relative padd-15">
                                                ...
                                                <Plusbin  keyIndex={item.id}  classname={"dieukhien opacity-0 -left-4 -top-0"} onClickfuncADD={ADDElement} onClickfuncDELETE={DELETEElement}/>
                                            </div>
                        ...
                        <div className="row">
                            <div id="edu_sample4" className=" education padd-15">
                                    ...
                                    <div className="timeline-box padd-15">
                                        ...
                                        <div className="timeline shadow-dark">
                                            {edu4.map((item) => (
                                                ...
                                                >
                                                   <Edu4 item={item}/>
                                                   <Plusbin  keyIndex={item.id}  classname={"dieukhien opacity-0 -left-6 -top-0"} onClickfuncADD={ADDElement2} onClickfuncDELETE={DELETEElement2}/>
                                                </div>
                                            ))}
                                        </div>
                                    </div>
                            ...
                            <div id="exp_sample4" className=" experience padd-15">
...
<Exp4 item={item}/>
                                                   <Plusbin  keyIndex={item.id}  classname={"dieukhien opacity-0 -left-6 -top-0"} onClickfuncADD={ADDElement3} onClickfuncDELETE={DELETEElement3}/>
